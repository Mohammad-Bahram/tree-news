...
const AddUser: React.FC<TAddUser> = ({ title, modal, direction }) => {
  ...
  return (
    <div className="">
      <button
        className="btn  max-sm:w-full max-sm:h-[40px] max-sm:text-[12px] h-[48px] bg-[#2F80ED] rounded-[10px] text-white text-[14px] font-bold flex flex-row justify-center items-center gap-x-2 w-[139px]"
        onClick={openModal}
      >
        <svg
