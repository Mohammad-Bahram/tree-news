...
const Advertisment = () => {
  const usersList: {
    ...
    {
      id: 1,
      adPosition: "بنر صفحه اصلی 1",
      startDate: "1403/04/14",
      endDate: "1403/04/21",
      status: true,
    },
    {
      id: 2,
      adPosition: "بنر صفحه اصلی 2",
    ...
    {
      id: 3,
      adPosition: "بنر صفحه دسته بندی",
      startDate: "1403/05/07",
      endDate: "1403/04/21",
      status: true,
    },
    {
      id: 4,
      adPosition: "بنر سکشن 1",
    ...
    <div className="w-full h-fit max-lg:h-fit pb-[30px] pt-[24px] bg-white flex flex-col justify-normal items-start rounded-[15px] px-6 shadow-[0px_0px_5px_rgba(0,0,0,11)]">
      ...
      >
        ...
        <div className="flex max-sm:flex-col max-sm:gap-y-4 max-sm:w-full flex-row gap-x-3">
          <UsersSearch />
          <AddAdvertisment title="تبلیغ جدید" />
        </div>
      </div>
      {usersList && (
