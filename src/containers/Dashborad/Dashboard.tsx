...
import StickSelect from "./stickSelect";
...
const Dashboard = () => {
  ...
  return (
    <div
      ...
      className="w-full h-fit max-lg:h-fit pb-[30px] pt-[24px] bg-white flex flex-col justify-normal items-start rounded-[15px] px-6 shadow-[0px_0px_5px_rgba(0,0,0,11)]"
    >
      <div
      ...
      >
        ...
        <div className="flex max-sm:flex-col max-sm:gap-y-4 max-sm:w-full flex-row gap-x-3">
          ...
          <UsersSearch />
          <AddUser
            direction="/admin/dashboard/addNews"
            modal={false}
            title="خبر"
          />
        </div>
            ...
            {usersList.map((elem) => {
              return (
                ...
                >
                  ...
                  <td className="border-none px-4 py-2  max-sm:p-0 text-right">
                    {elem.title}
                  </td>
