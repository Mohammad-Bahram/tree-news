...
const MessagesSearch = () => {
  ...
  return (
    <div className=" flex max-sm:flex-col max-sm:gap-y-4 max-md:w-full  flex-row gap-x-3">
      <div className="xl:w-[313px] max-md:w-[100%]   lg:w-[290px]   h-[48px] max-sm:h-[40px] relative ">
        <input
          onKeyDown={(e) => {
            console.log(e.key);
          ...
          {...register("searchBar")}
          type="text"
          className="w-[100%] h-full bg-[#F6F6F6] rounded-[10px] outline-none text-[#BDBDBD] text-[16px] pr-[49px] max-sm:text-[14px] "
          placeholder="جستجو"
        />
        <svg
